...
import (
	...
	"generalcompute2api/internal/testsuite"
)
...
func main() {
	...
	flag.StringVar(&opts.ConfigPath, "pool-fixture", opts.ConfigPath, "Gateway pool fixture JSON (keys + accounts) seeded into SQLite before the server starts")
