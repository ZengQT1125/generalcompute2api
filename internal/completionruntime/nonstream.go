...
func authOutputError(a *auth.RequestAuth) *assistantturn.OutputError {
	...
	return &assistantturn.OutputError{Status: http.StatusUnauthorized, Message: "Invalid token. If this should be a GeneralCompute2API key, add it to config.keys first.", Code: "error"}
}
