...
func TestLoadDotEnvLoadsWorkingDirectoryFileWithoutOverridingExistingEnv(t *testing.T) {
	...
	const newKey = "GENERALCOMPUTE2API_TEST_DOTENV_NEW"
	const keepKey = "GENERALCOMPUTE2API_TEST_DOTENV_KEEP"
	const quotedKey = "GENERALCOMPUTE2API_TEST_DOTENV_QUOTED"

	unsetEnv(t, newKey)
	unsetEnv(t, quotedKey)
	t.Setenv(keepKey, "from-env")

	content := "GENERALCOMPUTE2API_TEST_DOTENV_NEW=from-file\n" +
		"GENERALCOMPUTE2API_TEST_DOTENV_KEEP=from-file\n" +
		"GENERALCOMPUTE2API_TEST_DOTENV_QUOTED=\"line1\\nline2\"\n"
...
func TestLoadDotEnvStripsInlineCommentsFromUnquotedValues(t *testing.T) {
	...
	const plainKey = "GENERALCOMPUTE2API_TEST_DOTENV_PLAIN"
	const hashKey = "GENERALCOMPUTE2API_TEST_DOTENV_HASH"
	const quotedKey = "GENERALCOMPUTE2API_TEST_DOTENV_QUOTED_COMMENT"
	const exportKey = "GENERALCOMPUTE2API_TEST_DOTENV_EXPORT"
